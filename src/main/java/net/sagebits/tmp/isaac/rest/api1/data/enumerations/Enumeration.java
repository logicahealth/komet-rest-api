 ...
 * concrete subtype classes, such as {@link RestDynamicSemanticValidatorType} or {@link RestDynamicSemanticDataType}
 *
 * @see RestDynamicSemanticDataType
 * @see RestObjectChronologyType
 * @see RestSemanticType
 * @see RestConcreteDomainOperatorsType
 * @see RestDynamicSemanticValidatorType
 ...
 * @see RestDescriptionStyle
 * 
 * @author <a href="mailto:daniel.armbrust.list@sagebits.net">Dan Armbrust</a>
 */
@XmlSeeAlso ({
	RestDynamicSemanticDataType.class,
	RestObjectChronologyType.class,
	RestSemanticType.class,
	RestConcreteDomainOperatorsType.class,
	RestDynamicSemanticValidatorType.class,
