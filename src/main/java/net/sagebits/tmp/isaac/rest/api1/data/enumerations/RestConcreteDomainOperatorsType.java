...
public class RestConcreteDomainOperatorsType extends Enumeration
{
	...
	public ConcreteDomainOperators translate()
	{
		return ConcreteDomainOperators.values()[this.enumId];
	}

	public static RestConcreteDomainOperatorsType valueOf(String str)
	{
		if (StringUtils.isBlank(str))
		{
			throw new IllegalArgumentException("missing RestConcreteDomainOperatorsType");
		}
		for (ConcreteDomainOperators enumValue : ConcreteDomainOperators.values())
		{
			if (enumValue.name().equals(str.trim()))
			{
				return new RestConcreteDomainOperatorsType(enumValue);
			}
			else
			{
		...
		throw new IllegalArgumentException("invalid RestConcreteDomainOperatorsType value \"" + str + "\"");
	}
}