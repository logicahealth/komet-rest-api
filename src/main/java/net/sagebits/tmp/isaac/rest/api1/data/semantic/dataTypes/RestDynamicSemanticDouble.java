...
/**
 * 
 * {@link RestDynamicSemanticDouble}
 *
 * @author <a href="mailto:daniel.armbrust.list@sagebits.net">Dan Armbrust</a>
 */
@JsonAutoDetect(fieldVisibility = JsonAutoDetect.Visibility.ANY, getterVisibility = JsonAutoDetect.Visibility.NONE, setterVisibility = JsonAutoDetect.Visibility.NONE)
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY)
public class RestDynamicSemanticDouble extends RestDynamicSemanticData
{
	public RestDynamicSemanticDouble(int columnNumber, double value)
	{
		super(columnNumber, value);
	}

	protected RestDynamicSemanticDouble()
	{
		// for jaxb
	}
